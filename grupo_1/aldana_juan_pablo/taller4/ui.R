  ...
  dashboardBody(
    ...
    tags$div(id = "rsb",
      ...
      tags$button(class = "nav-btn",        id = "nb_ir",
        onclick = "navTo('tab_ir')",    tags$span("🔎"), "Buscador (IR)"),
    ...
    tabsetPanel(id = "main_tabs", type = "hidden",
      ...
      tabPanelBody("tab_scrap",
        h3("Actualización de datos — Scraping + Crossref",
           style = "color:#1E40AF; margin-bottom:4px;"),
        tags$p("Annual Review of Economics, volumenes 12 a 18 (2020-2026). Resumen, fecha exacta y referencias se extraen de la pagina de cada articulo; las citas se obtienen via las APIs de Crossref y OpenAlex (se usa el mayor conteo disponible).",
      ...
      tabPanelBody("tab_ir",
        h3("Buscador de artículos (Recuperación de Información)",
           style = "color:#1E40AF; margin-bottom:4px;"),
